package com.mikhail_dubov.nhs.lib;

import edu.stanford.nlp.ling.Word;

// NOTE(mikhaildubov): This is a slightly modified version of the Java class from CoreNLP:
//                     https://github.com/stanfordnlp/CoreNLP/blob/master/src/edu/stanford/nlp/process/Stemmer.java
//                     We had to add it into the project because it is not distributed inside the minimalistic
//                     stanford-corenlp.jar library that we use.
